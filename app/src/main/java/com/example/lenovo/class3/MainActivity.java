...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.main_menu,menu); //inflate main menu in main screen and attach it to menu
        return true;  //if we return false then it will not add main_menu to menu
    }
    ...
    public void setUpBoard(){
        ...
        mainLayout.removeAllViews(); //to remove all previous views if present
        for(int i = 0; i < n; i++){
